...
export default function () {
    return (
        <div style={{width:"100vw",overflowX:"hidden"}}>
                ...
                <div style={{position:"relative",top:"0", padding:"10px 0px", marginBottom:"5px",width:'100%',backgroundColor:"green", color:"white", textOverflow:"e",fontSize:"clamp(9px,3vw,20px)"}}>
